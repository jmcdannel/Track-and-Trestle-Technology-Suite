    ...
    <div class="navbar bg-base-100">
      ...
      <div class="navbar-center">
        <a class="btn btn-ghost normal-case text-xl">
          <span class="text-sm bg-clip-text bg-gradient-to-r from-cyan-300 to-violet-600 bl">Track & Trestle</span> 
          <span class="bg-clip-text bg-gradient-to-r from-red-800 to-fuchsia-700 uppercase font-extrabold">Throttle</span>
        </a>
      </div>
